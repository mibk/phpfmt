...
`,
		...
		[]token.Token{
			...
			{token.Whitespace, "\n", pos("5:13")},
			{token.Const, "const", pos("6:1")},
			{token.Whitespace, " ", pos("6:6")},
			{token.Ident, "match", pos("6:7")},
			{token.Assign, "=", pos("6:12")},
			{token.Int, "1", pos("6:13")},
			{token.Semicolon, ";", pos("6:14")},
			{token.Whitespace, "\n", pos("6:15")},
			{token.Use, "use", pos("7:1")},
			{token.Whitespace, " ", pos("7:4")},
			{token.Ident, "Foo", pos("7:5")},
			{token.Backslash, "\\", pos("7:8")},
			{token.Ident, "class", pos("7:9")},
			{token.Semicolon, ";", pos("7:14")},
			{token.EOF, "", pos("7:15")},
		},
	}, {
		"#[attr]",
