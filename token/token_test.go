...
`,
		...
		[]token.Token{
			{token.OpenTag, "<?php", pos("1:1")},
			{token.Whitespace, "\n", pos("1:6")},
			{token.Function, "function", pos("2:1")},
			{token.Whitespace, " ", pos("2:9")},
			{token.Ident, "match", pos("2:10")},
			{token.Lparen, "(", pos("2:15")},
			{token.Rparen, ")", pos("2:16")},
			{token.Lbrace, "{", pos("2:17")},
			{token.Rbrace, "}", pos("2:18")},
			{token.Whitespace, "\n", pos("2:19")},
			{token.Var, "$x", pos("3:1")},
			{token.Arrow, "->", pos("3:3")},
			{token.Ident, "class", pos("3:5")},
			{token.Semicolon, ";", pos("3:10")},
			{token.Whitespace, "\n", pos("3:11")},
			{token.Ident, "Foo", pos("4:1")},
			{token.DoubleColon, "::", pos("4:4")},
			{token.Ident, "global", pos("4:6")},
			{token.Lparen, "(", pos("4:12")},
			{token.Rparen, ")", pos("4:13")},
			{token.Semicolon, ";", pos("4:14")},
			{token.Whitespace, "\n", pos("4:15")},
			{token.Var, "$x", pos("5:1")},
			{token.QmarkArrow, "?->", pos("5:3")},
			{token.Ident, "return", pos("5:6")},
			{token.Semicolon, ";", pos("5:12")},
			{token.Whitespace, "\n", pos("5:13")},
			{token.Use, "use", pos("6:1")},
			{token.Whitespace, " ", pos("6:4")},
			{token.Ident, "Foo", pos("6:5")},
			{token.Backslash, "\\", pos("6:8")},
			{token.Ident, "class", pos("6:9")},
			{token.Semicolon, ";", pos("6:14")},
			{token.Whitespace, "\n", pos("6:15")},
			{token.Class, "class", pos("7:1")},
			{token.Whitespace, " ", pos("7:6")},
			{token.Ident, "Enum", pos("7:7")},
			{token.Semicolon, ";", pos("7:11")},
			{token.EOF, "", pos("7:12")},
		},
	}, {
		"lastType soft-keyword demotion",
		"<?php\ninterface Enum;\ntrait From;\nenum From;\nextends Enum;\nimplements From;\ninstanceof Enum;",
		[]token.Token{
			{token.OpenTag, "<?php", pos("1:1")},
			{token.Whitespace, "\n", pos("1:6")},
			{token.Interface, "interface", pos("2:1")},
			{token.Whitespace, " ", pos("2:10")},
			{token.Ident, "Enum", pos("2:11")},
			{token.Semicolon, ";", pos("2:15")},
			{token.Whitespace, "\n", pos("2:16")},
			{token.Trait, "trait", pos("3:1")},
			{token.Whitespace, " ", pos("3:6")},
			{token.Ident, "From", pos("3:7")},
			{token.Semicolon, ";", pos("3:11")},
			{token.Whitespace, "\n", pos("3:12")},
			{token.Enum, "enum", pos("4:1")},
			{token.Whitespace, " ", pos("4:5")},
			{token.Ident, "From", pos("4:6")},
			{token.Semicolon, ";", pos("4:10")},
			{token.Whitespace, "\n", pos("4:11")},
			{token.Extends, "extends", pos("5:1")},
			{token.Whitespace, " ", pos("5:8")},
			{token.Ident, "Enum", pos("5:9")},
			{token.Semicolon, ";", pos("5:13")},
			{token.Whitespace, "\n", pos("5:14")},
			{token.Implements, "implements", pos("6:1")},
			{token.Whitespace, " ", pos("6:11")},
			{token.Ident, "From", pos("6:12")},
			{token.Semicolon, ";", pos("6:16")},
			{token.Whitespace, "\n", pos("6:17")},
			{token.Instanceof, "instanceof", pos("7:1")},
			{token.Whitespace, " ", pos("7:11")},
			{token.Ident, "Enum", pos("7:12")},
			{token.Semicolon, ";", pos("7:16")},
			{token.EOF, "", pos("7:17")},
		},
	}, {
		"lastType negative: non-soft keyword stays",
		"<?php\ninterface match;",
		[]token.Token{
			{token.OpenTag, "<?php", pos("1:1")},
			{token.Whitespace, "\n", pos("1:6")},
			{token.Interface, "interface", pos("2:1")},
			{token.Whitespace, " ", pos("2:10")},
			{token.Match, "match", pos("2:11")},
			{token.Semicolon, ";", pos("2:16")},
			{token.EOF, "", pos("2:17")},
		},
	}, {
		"const lastType demotion",
		"<?php\nconst match=1;\nconst True=1;",
		[]token.Token{
			{token.OpenTag, "<?php", pos("1:1")},
			{token.Whitespace, "\n", pos("1:6")},
			{token.Const, "const", pos("2:1")},
			{token.Whitespace, " ", pos("2:6")},
			{token.Match, "match", pos("2:7")},
			{token.Assign, "=", pos("2:12")},
			{token.Int, "1", pos("2:13")},
			{token.Semicolon, ";", pos("2:14")},
			{token.Whitespace, "\n", pos("2:15")},
			{token.Const, "const", pos("3:1")},
			{token.Whitespace, " ", pos("3:6")},
			{token.ReservedConst, "True", pos("3:7")},
			{token.Assign, "=", pos("3:11")},
			{token.Int, "1", pos("3:12")},
			{token.Semicolon, ";", pos("3:13")},
			{token.EOF, "", pos("3:14")},
		},
	}, {
		"#[attr]",
